...
const ContactForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    setLoading(true);
    try {
      // GitHub Pages is static — open the user's mail client instead of an API route.
      ...
      toast({
        ...
        description: "Complete and send the message from your mail app.",
        variant: "default",
      ...
      toast({
        title: "Error",
        description: `Please email me directly at ${config.email}`,
        className: cn(
    ...
    <form className="min-w-7xl mx-auto sm:mt-4" onSubmit={handleSubmit} aria-busy={loading}>
      ...
      <div className="grid w-full gap-1.5 mb-4">
        ...
        <p className="text-sm text-muted-foreground">
          Uses your email client (mailto) — no data is stored on this site.
        </p>
      </div>
      <Button
        disabled={loading}
