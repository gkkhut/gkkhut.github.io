...
export const STATES = {
  ...
  // Keep skills-like pose through experience/education (reference pattern)
  expertise: {
    desktop: {
      scale: { x: 0.25, y: 0.25, z: 0.25 },
      position: { x: 0, y: -40, z: 0 },
  ...
  // Gap before Projects — same front-facing skills pose
  showcase: {
    desktop: {
  ...
  // Reference flipped pose so bongo cat is visible behind the keyboard
  projects: {
    desktop: {
      scale: { x: 0.25, y: 0.25, z: 0.25 },
      position: { x: 0, y: -40, z: 0 },
