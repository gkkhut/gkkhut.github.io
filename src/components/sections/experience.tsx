    ...
    >
      <div className="w-full max-w-4xl px-4 md:px-8 mx-auto">
        <SectionHeader
          id="experience"
          title="Experience"
          desc="Cross domain responsibilities in manufacturing, robotics, OT, and AI/ML."
    ...
    >
      ...
      >
        <CardHeader className="pb-3">
          <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
            <div className="space-y-1">
              ...
              <div className="text-base font-medium text-zinc-700 dark:text-muted-foreground">
                {experience.company}
              </div>
            </div>
        ...
        <CardContent className="space-y-6">
          <ul className="list-disc list-outside ml-4 space-y-2 text-sm md:text-base text-foreground leading-relaxed">
